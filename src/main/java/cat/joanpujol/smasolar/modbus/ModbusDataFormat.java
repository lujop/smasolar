...
public class ModbusDataFormat<T> {
  ...
  private static final FormatDecoder<String> FIX0_DECODER =
      new FormatDecoder<>() {
        @Override
  ...
  private static class DecimalFormatDecoder implements FormatDecoder<BigDecimal> {
    ...
    public Number format(Object value) {
      if (value instanceof Number) {
        ...
        return new BigDecimal(num.longValue()).divide(new BigDecimal(10 * numDecimals));
      } else if (value == null) {
        return null;
      } else
        throw new InvalidDataException(
  ...
  public static final ModbusDataFormat<String> FW =
      new ModbusDataFormat("Firmware version", String.class, STRING_DECODER);
  public static final ModbusDataFormat<String> HW =
      new ModbusDataFormat("Hardware version", String.class, STRING_DECODER);
